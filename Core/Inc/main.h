...
#define MCU_PRECHARGE_SIGNAL_Pin GPIO_PIN_12
#define MCU_PRECHARGE_SIGNAL_GPIO_Port GPIOB
#define MCU_CONTACTOR_SIGNAL_Pin GPIO_PIN_13
#define MCU_CONTACTOR_SIGNAL_GPIO_Port GPIOB
