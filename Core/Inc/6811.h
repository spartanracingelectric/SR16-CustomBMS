...
#define LTC_SERIES_GROUPS_PER_RDCV \
    3  // Number of cell voltage groups per 8 byte register
...
void LTC_WRCOMM(uint8_t total_ic,  // The number of ICs being written to
                uint8_t comm[6]    // A two dimensional array of the comm data
                                   // that will be written
);
