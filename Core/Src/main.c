...
//	uint8_t moduleCounts = 0;
  ...
  /* USER CODE BEGIN 2 */
    ...
    //bench test: assert the contactor right after the GPIOs come up, ahead of the LTC
    //startup delay, so the signal is present for the whole time the BMS is powered
